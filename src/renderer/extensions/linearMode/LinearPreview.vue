...
<template>
  <section
    ...
    class="absolute right-0 flex flex-wrap justify-center gap-2 p-2 text-sm tabular-nums opacity-0 hover:opacity-100 md:z-10"
  >
  ...
  <OutputHistory
    v-if="!isBuilderMode"
    :class="cn(!mobile && 'absolute bottom-0 z-10 min-w-0 opacity-0 hover:opacity-100')"
